        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost:8080/admin/editHomeContent">Setting</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        ...
        <script>
            function confirmToDelete(el) {
                document.getElementById("delete-button").setAttribute("href", el.getAttribute('data-href'));
